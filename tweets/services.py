...
class TweetService(object):
    ...
    def get_cached_tweets(cls, user_id):
        ...
        redis_key = USER_TWEETS_PATTERN.format(user_id=user_id)
    ...
    def push_tweet_to_cache(cls, tweet):
        ...
        redis_key = USER_TWEETS_PATTERN.format(user_id=tweet.user_id)
        return RedisHelper.push_object(redis_key, tweet, queryset)